...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-navy-900 flex items-center justify-center p-4 relative overflow-hidden mfg-theme">
      ...
      <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 bg-primary/80 backdrop-blur-xl border border-border-dark rounded-[2rem] overflow-hidden shadow-2xl relative z-10">
        <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-sidebar to-primary border-r border-border-dark relative overflow-hidden">
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-16">
              ...
              <div className="flex flex-col">
                <span className="font-black text-3xl tracking-tighter text-text-primary leading-none">
            ...
            <h1 className="text-4xl font-black text-text-primary leading-[1.1] tracking-tight mb-6">
              Next-Generation
              <br />
            ...
            <div className="space-y-4">
              <div className="glass p-5 rounded-2xl border-white/5 bg-white/5">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="font-bold text-text-primary">Shift-Based RBAC</h3>
                </div>
              ...
              <div className="glass p-5 rounded-2xl border-white/5 bg-white/5">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="font-bold text-text-primary">Full Traceability</h3>
                </div>
                <p className="text-sm text-text-secondary">
        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center relative bg-primary">
          <div className="w-full max-w-sm mx-auto">
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-2xl font-black text-text-primary tracking-tight mb-2">Secure Access</h2>
              <p className="text-text-secondary text-sm">Enter your credentials to authenticate.</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-5" noValidate>
              <div className="space-y-1.5">
                <label htmlFor="username" className="text-xs font-bold text-text-secondary uppercase tracking-widest">
                  Username
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-3 text-text-primary placeholder-text-secondary/40 focus:outline-none focus:border-accent transition-all focus:bg-white/10"
              ...
              <div className="space-y-1.5">
                <label htmlFor="password" className="text-xs font-bold text-text-secondary uppercase tracking-widest">
                  Password
                </label>
                <div className="relative">
            ...
            {import.meta.env.DEV && (
              <div className="mt-12 p-5 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={row.user} className="flex justify-between items-center text-sm p-2 rounded bg-white/5">
                      <span className="text-text-primary/70">{row.label}</span>
                ...
                <p className="text-[10px] text-text-secondary mt-3 text-center opacity-70">
                  Password for all accounts: <strong className="text-text-primary font-mono">123</strong>
                </p>
              </div>
            )}
          </div>
