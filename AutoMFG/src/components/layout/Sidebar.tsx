...
// Note: Logout / Help / Profile entries appear in the bottom group below.
import {
  ...
  return (
    <div className={cn(
      ...
      <div className="p-3 border-t border-border-dark shrink-0 space-y-1">
        ...
        >
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-accent to-forest-700 shrink-0 flex items-center justify-center text-white text-xs font-bold">
            {user?.avatarInitials || <UserIcon className="w-4 h-4" />}
          </div>
          {isOpen && (
        ...
        >
          ...
          {isOpen && <span className="text-[13px]">Help &amp; Support</span>}
        </Link>
