...
export const mockBreakdowns: Breakdown[] = [
  { id: 'TKT-8992', machineId: 'MCH-1042', machineName: 'CNC-Mill-04', location: 'Line 1, Cell A', priority: 'p1', status: 'in_progress', title: 'CNC-Mill-04 Spindle Overheat', faultCode: 'E-044', description: 'Spindle motor thermal trip. Coolant system suspected. Temperature reached 210°C vs 150°C limit.', reportedBy: 'J. Smith', assignedTo: 'Mike Kim', reportedAt: new Date(Date.now() - 72 * 60000).toISOString(), slaBreached: true, downtimeMinutes: 72, partsRequired: [{ partNumber: 'PUMP-V2', description: 'Coolant Pump Assembly', qty: 1, onHand: 0 }, { partNumber: 'FILT-09', description: 'In-line filter 10 micron', qty: 2, onHand: 1 }] },
