    ...
    <div className="flex flex-col h-[calc(100vh-11rem)] min-h-0">
      ...
      {selectedSupplier && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-2xl bg-sidebar h-full border-l border-border-dark shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right duration-300">
