    ...
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="flex-between">
        ...
        <div className="flex gap-3">
          <button 
            onClick={() => downloadCSV(lines, 'operations_dashboard_lines.csv')}
            className="px-4 py-2 bg-surface border border-border-dark rounded-md text-sm font-medium hover:border-accent transition-all"
          >
            Export CSV
          </button>
        </div>
